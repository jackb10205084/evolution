...
const assets = [
  {
    ...
    build(add) {
      add(rounded(2.08, 0.38, 0.9, 0.15), "primary", [0, 0.34, 0]);
      add(rounded(1.88, 0.48, 0.24, 0.11), "primary", [0, 0.61, 0.33], [-0.08, 0, 0]);
      add(rounded(0.18, 0.48, 0.9, 0.085), "primary", [-0.96, 0.45, 0]);
      add(rounded(0.18, 0.48, 0.9, 0.085), "primary", [0.96, 0.45, 0]);
      add(rounded(0.88, 0.16, 0.62, 0.075), "cream", [-0.46, 0.61, -0.1]);
      add(rounded(0.88, 0.16, 0.62, 0.075), "cream", [0.46, 0.61, -0.1]);
      add(rounded(0.42, 0.3, 0.13, 0.06), "accent", [0.48, 0.72, 0.17], [0.04, 0, -0.08]);
  ...
  },
  {
    ...
    build(add) {
      add(rounded(0.74, 0.2, 0.72, 0.1), "cream", [0, 0.43, 0]);
      add(rounded(0.68, 0.46, 0.18, 0.085), "primary", [0, 0.58, 0.27], [-0.08, 0, 0]);
      add(rounded(0.08, 0.14, 0.66, 0.038), "primary", [-0.35, 0.55, 0]);
      add(rounded(0.08, 0.14, 0.66, 0.038), "primary", [0.35, 0.55, 0]);
  ...
  },
  {
    ...
    build(add) {
      add(cylinder(0.5, 0.52, 0.14, 48), "wood", [0, 0.36, 0], [0, 0, 0], [1.08, 1, 0.7]);
      add(cylinder(0.12, 0.16, 0.28, 20), "edge", [0, 0.17, 0]);
      add(cylinder(0.3, 0.35, 0.07, 28), "wood", [0, 0.035, 0], [0, 0, 0], [1, 1, 0.78]);
    },
  },
  {
    file: "rug-meadow.glb",
